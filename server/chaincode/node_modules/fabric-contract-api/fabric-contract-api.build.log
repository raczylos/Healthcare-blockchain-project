...
> fabric-contract-api@2.5.0 lint
> eslint ./lib/


> fabric-contract-api@2.5.0 test:unit
> npm run test


> fabric-contract-api@2.5.0 test
> nyc mocha --recursive 'test/unit/**/*.js'
  ...
  Default.js
    Default
2023-01-05T09:56:51.026Z info [c-api:./lib/annotations/default.js]                @Default args: "Target ->","mockTarget" 
      ✔ should add set value for default when none set
2023-01-05T09:56:51.031Z info [c-api:./lib/annotations/default.js]                @Default args: "Target ->","mockTarget" 
      ✔ should error when default already set

  Info.js
    Info
2023-01-05T09:56:51.033Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when no objects exist for global yet
2023-01-05T09:56:51.035Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when objects exist for global
    Info with data
2023-01-05T09:56:51.037Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when no objects exist for global yet
2023-01-05T09:56:51.039Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when objects exist for global

  Object.js
    #Object
2023-01-05T09:56:51.042Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object as key when no objects exist for global yet
2023-01-05T09:56:51.044Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object as key when objects exist for global
2023-01-05T09:56:51.045Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object with no supertype
2023-01-05T09:56:51.047Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
  ...
  Transaction.js
    Transaction
2023-01-05T09:56:51.054Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should handle existing transactions
2023-01-05T09:56:51.058Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should error if missing type
2023-01-05T09:56:51.060Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should handle existing transactions of which matches name and already has param metadata
2023-01-05T09:56:51.062Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should create new metadata for fabric:transactions if none exist and handle no params
2023-01-05T09:56:51.063Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> false,","Target ->","Object" 
      ✔ should not add a tag if commit is false
    Returns
2023-01-05T09:56:51.066Z info [c-api:./lib/annotations/transaction.js]            @Returns args: ", Property Key -> mockKey, Return Type -> someType,","Target ->","Object" 
      ✔ should handle existing transactions
2023-01-05T09:56:51.067Z info [c-api:./lib/annotations/transaction.js]            @Returns args: ", Property Key -> mockKey, Return Type -> someType,","Target ->","Object" 
      ✔ should handle when there are no existing transactions
    Param
2023-01-05T09:56:51.069Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should overwrite when the transaction exists and param of name already in
2023-01-05T09:56:51.072Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should overwrite existing transaction but add new param when one with name does not exist
2023-01-05T09:56:51.074Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should append to transaction a new parameters array when transaction exists but has not parameters field
2023-01-05T09:56:51.076Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should handle when no transaction exists
2023-01-05T09:56:51.083Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> undefined,","Target ->","Object" 
...
2023-01-05T09:56:51.091Z error [c-api:./lib/contract.js]                          [some id] Contract contract-api.Contract unknown transaction "wibble", 
...
2023-01-05T09:56:51.100Z error [c-api:./lib/jsontransactionserializer.js]         undefined toBuffer validation against schema failed on type "number","string" 
...
2023-01-05T09:56:51.106Z error [c-api:./lib/jsontransactionserializer.js]         undefined fromBuffer no data supplied  
      ✔ should throw an error if nothing given
      ✔ should throw an error if not a number
      ✔ should throw an error if bad boolean given
2023-01-05T09:56:51.108Z error [c-api:./lib/jsontransactionserializer.js]         fromBuffer could not parse data as JSON to allow it to be converted to type: "some type" "trie",{} 
2023-01-05T09:56:51.108Z error [c-api:./lib/jsontransactionserializer.js]         Converting data to string and JSON.stringify-ing  
  ...
  Logger
    ✔ coverage
2023-01-05T09:56:51.115Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
2023-01-05T09:56:51.115Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
    getLogger
...
> fabric-contract-api@2.5.0 test:schema
