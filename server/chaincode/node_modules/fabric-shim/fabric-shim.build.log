...
> fabric-shim@2.5.0 lint
> eslint ./lib


> fabric-shim@2.5.0 test
...
2023-01-05T09:56:59.185Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
2023-01-05T09:56:59.189Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
      ✓ should start when passed init and invoke
2023-01-05T09:56:59.198Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
...
2023-01-05T09:56:59.253Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
2023-01-05T09:56:59.255Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
        ✓ should call handler.chat() with the correct object and output a message
2023-01-05T09:56:59.272Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
        ✓ should load the opts certificate attributes as JSON strings with the correct properties
    parsePeerUrlFcn
2023-01-05T09:56:59.279Z error [c-api:lib/chaincode.js]                           The "peer.address" program argument must be set to a legitimate value of <host>:<port>  
      ✓ should throw an error if peer.address not set
2023-01-05T09:56:59.299Z error [c-api:lib/chaincode.js]                           The "peer.address" program argument can not be set to an "http(s)" url, use grpc(s) or omit the protocol  
...
2023-01-05T09:56:59.428Z info [c-api:fabric-shim/cli]                             Bootstrap process completed  
      ✓ should handle resolved promise  correctly
2023-01-05T09:56:59.473Z info [c-api:fabric-shim/cli]                             Bootstrap process completed  
...
(node:2271) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 uncaughtException listeners added to [process]. Use emitter.setMaxListeners() to increase limit
...
2023-01-05T09:57:00.451Z info [c-api:contracts-spi/bootstrap.js]                  No metadata file supplied in contract, introspection will generate all the data  
      ✓ should handle when files not available
    #loadAndValidateMetadata
      ✓ validate and return the metadata (50ms)
...
<Buffer 44 65 66 61 75 6c 74 20 69 6e 69 74 69 61 74 6f 72 20 73 75 63 63 65 73 73 66 75 6c 2e>
    ...
    #invokeFunctionality
2023-01-05T09:57:00.812Z error [c-api:contracts-spi/chaincodefromcontract.js]     a logging prefix Error: Contract name is not known: name  
...
2023-01-05T09:57:00.917Z error [c-api:contracts-spi/datamarshall.js]              undefined Expected 1 parameters, but 0 have been supplied  
...
2023-01-05T09:57:00.952Z error [c-api:lib/handler.js]                             Failed to find a message for transaction context id theChannelIDaTX  
...
2023-01-05T09:57:00.962Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ✓ should set endpoint, client and default timeout
2023-01-05T09:57:00.964Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ✓ should override the default request timeout if value passed
2023-01-05T09:57:00.972Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ✓ should store additional grpc options
2023-01-05T09:57:00.973Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ...
      ✓ should throw an error if connection secure encoded private key not passed as opt
2023-01-05T09:57:00.978Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ✓ should set endpoint, client and default timeout for a secure connection
2023-01-05T09:57:00.982Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
      ✓ should set grpc ssl options when ssl-target-name-override passed
      close
2023-01-05T09:57:00.983Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
        ✓ should call end on the stream
      chat
2023-01-05T09:57:00.985Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
        ✓ should create an instance of ChaincodeMessageHandler and pass the argument
      toString
2023-01-05T09:57:01.003Z info [c-api:lib/handler.js]                              Creating new Chaincode Support Client for peer comminications  
    ...
    ChaincodeMessageHandler
      chat
        ...
        stream.on.data
2023-01-05T09:57:01.026Z error [c-api:lib/handler.js]                             Chaincode is in "created" state, can only process messages of type "registered", but received "NOT REGISTERED"  
          ✓ should throw error when in state created and MSG_TYPE not REGISTERED
2023-01-05T09:57:01.042Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2023-01-05T09:57:01.042Z error [c-api:lib/handler.js]                             Chaincode is in "ready" state, can only process messages of type "established", but received "NOT REGISTERED"  
          ✓ should throw error when in state established and MSG_TYPE not READY
2023-01-05T09:57:01.055Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2023-01-05T09:57:01.055Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should do nothing when in state ready and MSG_TYPE equals REGISTERED
2023-01-05T09:57:01.092Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2023-01-05T09:57:01.092Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should do nothing when in state ready and MSG_TYPE equals READY
2023-01-05T09:57:01.103Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2023-01-05T09:57:01.104Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleMsgResponse when in state ready and MSG_TYPE equals RESPONSE
2023-01-05T09:57:01.117Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2023-01-05T09:57:01.118Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleMsgResponse when in state ready and MSG_TYPE equals ERROR
2023-01-05T09:57:01.129Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2023-01-05T09:57:01.130Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleInit when in state ready and MSG_TYPE equals INIT
2023-01-05T09:57:01.141Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2023-01-05T09:57:01.141Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleTransaction when in state ready and MSG_TYPE equals TRANSACTION
2023-01-05T09:57:01.155Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2023-01-05T09:57:01.155Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
2023-01-05T09:57:01.155Z error [c-api:lib/handler.js]                             Received unknown message from the peer. Exiting.  
          ✓ should end the process with value 1
        stream.on.end
          ✓ should cancel the stream
        stream.on.error
2023-01-05T09:57:01.179Z error [c-api:lib/handler.js]                             Chat stream with peer - on error: %j {} 
          ✓ should end the stream
2023-01-05T09:57:01.191Z error [c-api:lib/handler.js]                             Chat stream with peer - on error: %j "Error\n    at Context.<anonymous> (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/libraries/fabric-shim/test/unit/handler.js:857:35)\n    at callFn (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runnable.js:366:21)\n    at Test.Runnable.run (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runnable.js:354:5)\n    at Runner.runTest (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:681:10)\n    at /home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:804:12\n    at next (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:596:14)\n    at /home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:606:7\n    at next (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:489:14)\n    at Immediate._onImmediate (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/mocha@9.1.3/node_modules/mocha/lib/runner.js:574:5)\n    at processImmediate (node:internal/timers:466:21)" 
    ...
    handleMessage
      Error
2023-01-05T09:57:01.600Z error [c-api:lib/handler.js]                             %s Incorrect payload format. Sending ERROR message back to peer "[theChannelID-01234567]" 
        ✓ should handle an error decoding the payload
2023-01-05T09:57:01.602Z error [c-api:lib/handler.js]                             Failed to construct a chaincode stub instance from the INIT message: an error
    at Object.fake.exceptionCreator (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/sinon@13.0.1/node_modules/sinon/lib/sinon/default-behaviors.js:18:32)
    at Object.invoke (/home/runner/work/fabric-chaincode-node/fabric-chaincode-node/common/temp/node_modules/.pnpm/sinon@13.0.1/node_modules/sinon/lib/sinon/behavior.js:165:35)
...
2023-01-05T09:57:01.604Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Init() has not called success or error.  
2023-01-05T09:57:01.604Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Init() returned error response [[theChannelID-01234567] Calling chaincode Init() has not called success or error.]. Sending COMPLETED message back to peer  
        ✓ should handle chaincode.Init returning nothing
2023-01-05T09:57:01.605Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Invoke() has not called success or error.  
2023-01-05T09:57:01.606Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Invoke() returned error response [[theChannelID-01234567] Calling chaincode Invoke() has not called success or error.]. Sending COMPLETED message back to peer  
        ✓ should handle chaincode.Invoke returning nothing
2023-01-05T09:57:01.607Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Init() has not called success or error.  
2023-01-05T09:57:01.607Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Init() returned error response [[theChannelID-01234567] Calling chaincode Init() has not called success or error.]. Sending COMPLETED message back to peer  
        ✓ should handle chaincode.Init returning no status
2023-01-05T09:57:01.609Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Invoke() has not called success or error.  
2023-01-05T09:57:01.609Z error [c-api:lib/handler.js]                             [theChannelID-01234567] Calling chaincode Invoke() returned error response [[theChannelID-01234567] Calling chaincode Invoke() has not called success or error.]. Sending COMPLETED message back to peer  
        ✓ should handle chaincode.Invoke returning no status
      Complete
2023-01-05T09:57:01.611Z info [c-api:lib/handler.js]                              [theChannelID-01234567] Calling chaincode Init() succeeded. Sending COMPLETED message back to peer  
        ✓ should write a COMPLETE message when successful init
2023-01-05T09:57:01.612Z info [c-api:lib/handler.js]                              [theChannelID-01234567] Calling chaincode Invoke() succeeded. Sending COMPLETED message back to peer  
...
2023-01-05T09:57:01.675Z error [c-api:lib/iterators.js]                           unexpected error received getting next value: %s "this.response.getId is not a function" 
  ...
  Logger
    ✓ coverage
2023-01-05T09:57:01.690Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
2023-01-05T09:57:01.690Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
    getLogger
...
2023-01-05T09:57:01.737Z error [c-api:lib/server.js]                              ChaincodeServer failed to bind to 0.0.0.0:9999  
      ✓ should throw if bindAsync fails
    connect()
      ✓ should call connect
2023-01-05T09:57:01.741Z warn [c-api:lib/server.js]                               connection from peer failed: Error: Some error from chat  
...
=============================== Coverage summary ===============================
Statements   : 100% ( 1299/1299 )
Branches     : 100% ( 508/508 )
